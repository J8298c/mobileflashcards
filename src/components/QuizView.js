                    ...
                    <View>
                       {
                           ...
                           <View>
                                ...
                                <AppButton buttonText='Go to Deck' onPress={() => Actions.Deck({id: this.state.deck.title})} />
                                <AppButton buttonText='Restart' onPress={() => this.setState({questionNumber: 0, scoreScreen: false})} />
                           </View>
                       }
